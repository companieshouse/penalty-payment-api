...
| `KAFKA_ZOOKEEPER_ADDR`                        |   `_`   | Kafka Zookeeper Address e.g. zookeeper:2181                                  | ecs-service-configs-dev(CIDEV) / ecs-service-configs-prod (STAGING/LIVE) |
| `KAFKA_ZOOKEEPER_CHROOT`                      |   `_`   | Kafka Zookeeper chroot                                                       | ecs-service-configs-dev(CIDEV) / ecs-service-configs-prod (STAGING/LIVE) |
...
| `KAFKA3_ZOOKEEPER_ADDR`                       |   `_`   | Kafka3 Zookeeper Address e.g. zookeeper-kafka3:2181                          | ecs-service-configs-dev(CIDEV) / ecs-service-configs-prod (STAGING/LIVE) |
