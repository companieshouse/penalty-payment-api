...
type Config struct {
	...
	AccountPenaltiesTTLHours   time.Duration `env:"PPS_ACCOUNT_PENALTIES_TTL_HOURS"                  flag:"account-penalties-ttl-hours"          flagDesc:"The time to live for account penalties cache entry"`
