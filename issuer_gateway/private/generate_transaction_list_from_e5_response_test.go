...
func TestUnit_getPayableStatus(t *testing.T) {
	Convey("Get open payable status for late filing penalty", t, func() {
		...
		testCases := []struct {
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = CHS, dunningStatus = PEN1DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = CHS, dunningStatus = PEN2DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = CHS, dunningStatus = PEN3DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = DCA, dunningStatus = PEN1DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = DCA, dunningStatus = PEN2DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = DCA, dunningStatus = PEN3DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = HLD, dunningStatus = PEN1DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = HLD, dunningStatus = PEN2DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = HLD, dunningStatus = PEN3DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = WDR, dunningStatus = PEN1DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = WDR, dunningStatus = PEN2DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = WDR, dunningStatus = PEN3DunningStatus,",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
	...
	Convey("Get closed payable status for late filing penalty", t, func() {
		...
		testCases := []struct {
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = DCA, dunningStatus = DCA",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = CHS, dunningStatus = DCA",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = HLD, dunningStatus = DCA",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
			...
			{
				name: "Late filing penalty with outstanding amount, not paid, accountStatus = WDR, dunningStatus = DCA",
				args: args{transaction: &e5.Transaction{
					CompanyCode:       utils.LateFilingPenalty,
					OutstandingAmount: 150,
					IsPaid:            false,
