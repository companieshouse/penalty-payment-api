...
// Source: common/interfaces/mongo_interfaces.go
...
import (
	...
	interfaces "github.com/companieshouse/penalty-payment-api/common/interfaces"
...
func (m *MockMongoClientProvider) Client() *mongo.Client {
	m.ctrl.T.Helper()
...
func (mr *MockMongoClientProviderMockRecorder) Client() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Client", reflect.TypeOf((*MockMongoClientProvider)(nil).Client))
}

// Database mocks base method.
func (m *MockMongoClientProvider) Database(name string) *mongo.Database {
	m.ctrl.T.Helper()
...
func (mr *MockMongoClientProviderMockRecorder) Database(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Database", reflect.TypeOf((*MockMongoClientProvider)(nil).Database), name)
}
...
func (m *MockMongoDatabaseInterface) Collection(name string, opts ...*options.CollectionOptions) interfaces.MongoCollectionInterface {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(interfaces.MongoCollectionInterface)
	return ret0
}
