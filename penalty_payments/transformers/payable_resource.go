...
func PayableResourceRequestToDB(req *models.PayableRequest, context string) *models.PayableResourceDao {
	...
	if err != nil {
		log.ErrorC(context, fmt.Errorf("error generating etag: [%s]", err))
	}
