...
func PayResourceHandler(payableResourceService *services.PayableResourceService, e5Client e5.ClientInterface,
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		go sendConfirmationEmail(resource, payment, r, w, apDaoSvc, *penaltyConfig)
...
func sendConfirmationEmail(resource *models.PayableResource, payment *validators.PaymentInformation,
	r *http.Request, w http.ResponseWriter, apDaoSvc dao.AccountPenaltiesDaoService, penaltyConfig configctx.ConfigContext) {
	...
	defer wg.Done()
	err := handleSendEmailKafkaMessage(*resource, r, apDaoSvc, penaltyConfig)
	if err != nil {
