...
func PayResourceHandler(payableResourceService *services.PayableResourceService, e5Client *e5.Client,
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		go updateIssuer(e5Client, resource, payment, r, w)
...
func updateDatabase(resource *models.PayableResource, payment *validators.PaymentInformation, payableResourceService *services.PayableResourceService, r *http.Request, w http.ResponseWriter) {
...
func updateIssuer(e5Client *e5.Client, resource *models.PayableResource, payment *validators.PaymentInformation, r *http.Request, w http.ResponseWriter) {
