...
func PayResourceHandler(payableResourceService *common.PayableResourceService, e5Client *e5.Client,
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		go updateIssuer(e5Client, resource, payment, payableResourceService, r, w)
...
func updateDatabase(resource *models.PayableResource, payment *validators.PaymentInformation, svc *common.PayableResourceService, r *http.Request, w http.ResponseWriter) {
...
func updateIssuer(e5Client *e5.Client, resource *models.PayableResource, payment *validators.PaymentInformation, svc *common.PayableResourceService, r *http.Request, w http.ResponseWriter) {
	// Mark the resource as paid in e5
	defer wg.Done()
	err := api.UpdateIssuerAccountWithPenaltyPaid(e5Client, *resource, *payment)
	if err != nil {
