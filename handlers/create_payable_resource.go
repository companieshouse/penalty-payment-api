...
func CreatePayableResourceHandler(svc dao.Service, penaltyDetailsMap *config.PenaltyDetailsMap, allowedTransactionsMap *models.AllowedTransactionMap) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		validTransactions, err :=
			validators.TransactionsArePayable(request.CompanyNumber, companyCode, request.Transactions, penaltyDetailsMap, allowedTransactionsMap)
		if err != nil {
