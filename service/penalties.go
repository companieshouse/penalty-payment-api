...
func GetPenalties(companyNumber string, companyCode string, penaltyDetailsMap *config.PenaltyDetailsMap,
	allowedTransactionsMap *models.AllowedTransactionMap) (*models.TransactionListResponse, common.ResponseType, error) {
	cfg, err := config.Get()
	if err != nil {
		return nil, common.Error, nil
	}
	...
	return generatedTransactionListFromE5Response, common.Success, nil
}
