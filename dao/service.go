...
type Service interface {
	...
	// GetPayableResource will find a single payable resource with the given customerCode and reference
	GetPayableResource(customerCode, reference string) (*models.PayableResourceDao, error)
	...
	SaveE5Error(customerCode, reference string, action e5.Action) error
